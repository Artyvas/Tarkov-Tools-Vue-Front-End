    ...
    <div id="wrapper">
      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <div class="sidebar-card">
          ...
          <div>Tarkov Tools Pro</div>
          <p class="text-center mb-2">
            Become a patreon to unlock 7+ Maps and Pro level content!
          </p>
          <a class="btn btn-success btn-sm" href="https://patreon.com">Become a Patreon!</a>
        </div>
      </ul>
      <!-- End of Sidebar -->
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown no-arrow">
                <a
                  ...
                  aria-expanded="false"
                >
                  <span class="mr-2 d-none d-lg-inline text-gray-600 small">User Mcuserson</span>
        ...
        <footer class="sticky-footer bg-white">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright &copy; Tarkov Tools 2021</span>
            </div>
          </div>
        </footer>
        <!-- End of Footer -->
